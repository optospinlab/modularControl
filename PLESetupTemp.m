...
%     c = mcaPoints.promptBrightSpotConfig();
    ...
    data = mcData(mcData.squareScanConfiguration(mcaDAQ(configPiezoX), mcaDAQ(configPiezoY), mciDAQ(mciDAQ.counterConfig), 30, 15, 400));
    ...
    i5 = mciDaughter(mciDaughter.daughterConfig(e, 'aSpec', [512 1], 'pixels'));
    i6 = mciDaughter(mciDaughter.daughterConfig(e, 'aSpec2', [512 1], 'pixels'));
...
%     saveas(gcf, 'Points.png');  % Temp!
    ...
    d.axes =    {a};
    d.scans =   {1:a.config.nums};
    d.inputs =  {mcePLE(e), i1, i2, i3, i4, i5, i6}; %, i6, i7, i8, i9, i10, i11};
