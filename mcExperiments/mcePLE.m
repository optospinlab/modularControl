...
%             specData =      mcData.inputConfig(spectrometer);
            ...
            greenOD2 =      mcaDAQ.greenConfig();   greenOD2.chn = 'Port0/Line2';
            ...
            sl = 1;    % (seconds) = Spectrum Length
            
            config.overview =   'Overview should be used to describe a mcExperiment.';
            config.steps =      {   {'Green Off',           greenDigital,   0,          'For posterity, turn the green off while we play around with the red.'};...
                                    ...
                                    {'Align Red',           redSerial,      NaN,        'Set the wavelength of the red laser to be on the ZPL.'};...
