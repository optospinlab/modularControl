...
%                         'Callback', @dc.YVoltageSpectra);               ii = ii + 2;
            ...
            uicontrol(                  'Parent', dc.f,...
                                        ...
                                        'HorizontalAlignment', 'right',...
                                        'Position', [dc.pw/6, dc.ph - ii*bh, dc.pw/3, bh]);
            dc.ple.upPixels = uicontrol('Parent', dc.f,...
                                        'Style', 'edit',... 
                                        'String', 240,...
                                        'Position', [dc.pw/2, dc.ph - ii*bh, dc.pw/3, bh]);     ii = ii + 1;
            ...
            uicontrol(                  'Parent', dc.f,...  
                                        ...
                                        'HorizontalAlignment', 'right',...
                                        'Position', [dc.pw/6, dc.ph - ii*bh, dc.pw/3, bh]);
            dc.ple.upTime = uicontrol(  'Parent', dc.f,...
                                        'Style', 'edit',... 
                                        'String', 10,...
                                        'Position', [dc.pw/2, dc.ph - ii*bh, dc.pw/3, bh]);     ii = ii + 1;
            ...
            uicontrol(                  'Parent', dc.f,...  
                                        ...
                                        'HorizontalAlignment', 'right',...
                                        'Position', [dc.pw/6, dc.ph - ii*bh, dc.pw/3, bh]);
            dc.ple.downTime = uicontrol('Parent', dc.f,...
                                        'Style', 'edit',... 
                                        'String', 1,...
                                        'Position', [dc.pw/2, dc.ph - ii*bh, dc.pw/3, bh]);     ii = ii + 1;
            ...
            uicontrol(                  'Parent', dc.f,...  
                                        ...
                                        'HorizontalAlignment', 'right',...
                                        'Position', [dc.pw/6, dc.ph - ii*bh, dc.pw/3, bh]);
            dc.ple.numScans = uicontrol('Parent', dc.f,...
                                        'Style', 'edit',... 
                                        'String', 20,...
                                        'Position', [dc.pw/2, dc.ph - ii*bh, dc.pw/3, bh]);     ii = ii + 1;
            ...
            uicontrol(                  'Parent', dc.f,...  
                                        ...
                                        'HorizontalAlignment', 'right',...
                                        'Position', [dc.pw/6, dc.ph - ii*bh, dc.pw/3, bh]);
            dc.ple.xMin = uicontrol(    'Parent', dc.f,...
                                        'Style', 'edit',... 
                                        'String', 0,...
                                        'Position', [dc.pw/2, dc.ph - ii*bh, dc.pw/3, bh]);     ii = ii + 1;
            ...
            uicontrol(                  'Parent', dc.f,...  
                                        ...
                                        'HorizontalAlignment', 'right',...
                                        'Position', [dc.pw/6, dc.ph - ii*bh, dc.pw/3, bh]);
            dc.ple.xMax = uicontrol(    'Parent', dc.f,...
                                        'Style', 'edit',... 
                                        'String', 3,...
                                        'Position', [dc.pw/2, dc.ph - ii*bh, dc.pw/3, bh]);     ii = ii + 1.25;
            ...
            uicontrol(  'Parent', dc.f,...  
                        ...
                        'String', 'PLE!',... 
                        'Position', [dc.pw/6, dc.ph - ii*bh, 2*dc.pw/3, bh],... 
                        'Callback', @dc.PLE_Callback);                                          ii = ii + 2;
...
%             dc.input.config.axesGroups{3}{3}
        ...
        function PLE_Callback(dc,~,~)
            % Setup the data config
            d.axes = {mcAxis};  % This is the time axis
            d.scans = {1:round(str2double(dc.ple.numScans.String))};   % Scan for 20 time points

                                % mciPLE.PLEConfig(xMin, xMax, upPixels, upTime (s), downTime (s))
            d.inputs = {mciPLE(   mciPLE.PLEConfig( str2double(dc.ple.xMin.String),...      % No error correction (e.g. check integer) because config should(?) catch it.
                                                    str2double(dc.ple.xMax.String),...
                                                    str2double(dc.ple.upPixels.String),...
                                                    str2double(dc.ple.upTime.String),...
                                                    str2double(dc.ple.downTime.String)))};
