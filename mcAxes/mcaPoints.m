...
%                     fname
            ...
            c2.controls =     { { 'title',  'Options:  ',           NaN,        'Use the following options to configure how bright spots are detected' },...
                                ...
                                { 'edit',   'Dialate:  ',           1,          'To prevent two accidental maxima on the same spot, the maxima are dialated in a diamond shape outward by this value. Nearby maxima (i.e. maxima on the same bright spot) will merge.',     [0 Inf 1]},...
